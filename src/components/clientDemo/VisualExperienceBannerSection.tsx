...
import { MessageCircle, Phone, QrCode, MapPin, Image as ImageIcon } from 'lucide-react';
 ...
 * The internal authoring tool is NEVER linked from here — we render a
 * clean preview composition built from the client's real assets.
 */
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto grid gap-12 lg:grid-cols-[1fr_1.1fr] items-center">
        ...
        {/* Preview column · clean visual mock, no internal tool exposed */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, amount: 0.25 }}
          transition={{ duration: 0.7, delay: 0.1 }}
          className="relative aspect-[4/5] md:aspect-[16/11] border border-[#A68B5B]/30 bg-[#15120e] overflow-hidden shadow-2xl"
          aria-label={`Preview de Experiencia Visual de Propiedad para ${clientName}`}
        >
          {/* Hero image */}
          {previewImage ? (
            <img
          ...
          {/* Bottom gradient overlay + content strip */}
