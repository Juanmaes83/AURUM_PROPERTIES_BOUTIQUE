...
const fourHooks = [
  {
    ...
    desc: 'Pieza animada con la propiedad, CTA y contacto directo. Lista para enviar por WhatsApp o incrustar en web.',
  ...
  },
  {
    ...
    desc: 'Esta página: diagnóstico, comparativa, experiencia visual integrada y contacto. Para enviar a decisores.',
  ...
  },
  {
    ...
    desc: 'Propuesta de presencia digital completa: narrativa de marca, zonas, servicios y captación de propietarios.',
  ...
  },
  {
    ...
    desc: 'Formatos vertical 9:16 y horizontal 16:9 con claim y CTA. Para stories, WhatsApp y campaña digital.',
...
const valueProps = [
  { label: 'Captación más rápida', body: 'El comprador entiende la propiedad antes de llamar. Menos tiempo de cualificación, más visitas reales.' },
  { label: 'Percepción premium', body: 'La presentación visual eleva la percepción de la agencia y diferencia a Sandhouse de la competencia local.' },
  { label: 'Activos reutilizables', body: 'La misma experiencia se puede enviar por WhatsApp, poner en web, usar en campaña y compartir en redes.' },
  { label: 'Primera impresión decisiva', body: 'En Torrevieja, el comprador compara varias agencias. La que impacta primero, capta primero.' },
];

export const SandhouseLanding = () => {
  useSmoothScroll();

  return (
    <>
      <Helmet>
        <title>Sandhouse Inmobiliaria · Propuesta Visual · Immersphere</title>
        <meta
          name="description"
          content="Propuesta visual personalizada para Sandhouse Inmobiliaria: experiencia interactiva, landing comercial, web completa y banners para Torrevieja y la Costa Levantina."
        />
      ...
      <main className="bg-[#0B0B0C] text-[#F7F7F7]">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-[#555] leading-relaxed max-w-2xl mb-12">
                Cada pieza tiene un objetivo comercial propio. Juntas forman un sistema visual que Sandhouse puede
                usar en WhatsApp, web, campañas y presentaciones con compradores.
              </p>
            </motion.div>
          ...
          <div className="max-w-6xl mx-auto grid gap-10 lg:grid-cols-[0.9fr_1.1fr] items-start">
            <div>
              ...
              <h2 className="font-serif text-4xl md:text-5xl leading-tight mt-4">
                Más impacto visual. Más captación. Más diferenciación.
              </h2>
            </div>
        ...
        <section className="bg-[#0e0c0a] py-20 px-6 md:px-12">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-4 text-sm text-[#b0a390]">
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <span>{cfg.client.phone2}</span>
                  <span>{cfg.client.phone3}</span>
                </div>
              </div>
              <div className="flex items-start gap-2">
