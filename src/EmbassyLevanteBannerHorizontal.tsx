...
export const EmbassyLevanteBannerHorizontal = () => {
  return (
    <>
      <Helmet>
        <title>Banner Horizontal · Embassy Levante · Immersphere</title>
      ...
      <div className="min-h-screen bg-[#060504] text-[#F7F7F7] flex flex-col items-center justify-center py-12 px-6">
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                'linear-gradient(120deg, #0d0b09 0%, #1a1208 35%, #0f0c07 65%, #080604 100%)',
            }}
          />
          ...
          <div className="absolute inset-0 flex flex-col justify-center px-8 pr-[47%]">
            ...
            >
              ...
              <p className="text-[#8a8078] leading-relaxed" style={{ fontSize: 'clamp(0.65rem, 1.5vw, 0.8rem)' }}>
                Captación de propietarios y compraventa en Torrevieja y la Costa Blanca con argumento visual real.
              </p>
          ...
          <div className="absolute top-0 right-0 bottom-0 flex flex-col justify-between py-6 px-6" style={{ left: '57%' }}>
            <div className="flex flex-wrap gap-1.5">
              {['Propietarios', 'Captación', 'Venta'].map((chip) => (
                <span
                  key={chip}
            ...
            <div>
              ...
              <div className="space-y-1 mb-5">
                <p className="text-[9px] text-[#9a9080]">+34 691 502 743</p>
                <p className="text-[9px] text-[#9a9080]">luisiglesias@embassylevante.com</p>
              </div>
