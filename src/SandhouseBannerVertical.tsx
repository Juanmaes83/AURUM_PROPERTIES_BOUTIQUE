...
export const SandhouseBannerVertical = () => {
  return (
    <>
      <Helmet>
        <title>Banner Vertical · Sandhouse Inmobiliaria · Immersphere</title>
      ...
      <div className="min-h-screen bg-[#060504] text-[#F7F7F7] flex flex-col items-center justify-center py-12 px-6">
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                'linear-gradient(160deg, #080604 0%, #1c1409 30%, #0d0b06 60%, #070504 100%)',
            }}
          />
          ...
          <div className="absolute top-0 left-0 right-0 flex items-center justify-between px-5 py-4 border-b border-[#c4a96a]/15">
            <div className="flex items-center gap-2">
              ...
              <span className="font-serif text-[#c4a96a] text-base tracking-wide">Sandhouse</span>
            </div>
          ...
          <div className="absolute inset-0 flex flex-col justify-center px-6 pt-16 pb-24">
            ...
            >
              ...
              <p className="text-[#9a9080] text-sm leading-relaxed mb-8">
                La mejor manera de encontrar tu hogar en Torrevieja y en la costa levantina. Agencia inmobiliaria
                especializada. Atencion personalizada.
              </p>
              ...
              <div className="flex flex-wrap gap-2">
                {['Compra', 'Venta', 'Asesoramiento', 'Torrevieja'].map((chip) => (
                  <span
                    key={chip}
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-[#f5f0e8] font-semibold mt-0.5">+34 655 187 116</p>
                <p className="text-[9px] text-[#7a7068] mt-0.5">info@sandhouse.es</p>
              </div>
              <div
                className="bg-[#c4a96a] text-black text-[9px] font-bold tracking-[0.16em] uppercase px-4 py-2.5 flex flex-col items-center"
              >
                <span>Ver</span>
                <span>propiedad</span>
              </div>
