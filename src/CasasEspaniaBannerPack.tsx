...
const CLAIMS = [
  ...
  'Compra, venta y alquiler. Tu propiedad en Torrevieja con Casas Espania.',
  'Casas Espania muestra el potencial de tu vivienda antes de firmar.',
];
...
const formats = [
  {
    ...
    href: '/banners/casas-espania/vertical',
    previewRatio: '9/16',
    previewMaxH: 420,
  },
  {
    ...
    href: '/banners/casas-espania/horizontal',
    previewRatio: '16/9',
    previewMaxH: 220,
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 right-0 flex items-center justify-between px-4 py-3 border-b border-[#c4a96a]/15">
        <span className="font-serif text-[#c4a96a] text-sm tracking-wide">Casas Espania</span>
      ...
      >
        ...
        >
          Tu propiedad en Torrevieja con Casas Espania.
        </p>
        <p
          className="text-[#b0a390] leading-relaxed"
          style={{ fontSize: isVertical ? '0.8rem' : '0.7rem' }}
        >
          Agencia inmobiliaria en Torrevieja · Costa Blanca · Alicante
        </p>
      </div>
      ...
      <div className="absolute bottom-0 left-0 right-0 px-4 py-3 bg-gradient-to-t from-black/80 to-transparent">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-[10px] text-[#f5f0e8] font-semibold">+34 966 785 202</p>
          </div>
...
export const CasasEspaniaBannerPack = () => {
  return (
    <>
      <Helmet>
        <title>Pack de Banners · Casas Espania · Immersphere</title>
      ...
      <div className="min-h-screen bg-[#0B0B0C] text-[#F7F7F7] font-[Inter,sans-serif]">
        ...
        <div className="border-b border-[#c4a96a]/15 px-6 py-4 flex items-center justify-between">
          <div>
            <span className="font-serif text-[#c4a96a] text-lg">Casas Espania</span>
        ...
        <section className="px-6 md:px-12 py-16 max-w-5xl mx-auto">
          ...
          >
            <p className="text-[10px] font-mono text-[#c4a96a] tracking-[0.28em] uppercase mb-4">
              CASAS ESPANIA · CREATIVIDADES VISUALES
            </p>
            <h1 className="font-serif text-4xl md:text-5xl leading-tight mb-6 max-w-2xl">
              Banners personalizados para Torrevieja y la Costa Blanca.
            </h1>
            <p className="text-[#8a8078] leading-relaxed max-w-xl">
              Formatos vertical 9:16 y horizontal 16:9 con claim, identidad Casas Espania y CTA de contacto
              directo. Listos para captación de propietarios, stories, display y presentaciones.
            </p>
          </motion.div>
        </section>
        ...
        <section className="bg-[#0e0c0a] px-6 md:px-12 py-16 text-center">
          ...
          <h2 className="font-serif text-3xl md:text-4xl mb-6">
            Activos listos para campaña de captación.
          </h2>
          <p className="text-[#8a8078] max-w-md mx-auto mb-10 text-sm leading-relaxed">
            Una vez validados por Casas Espania, estos banners se adaptan a propiedades reales y se
            entregan listos para activar en captación de propietarios y campaña digital.
          </p>
          <a
            href="https://wa.me/34966785202?text=Hola%2C%20quiero%20ver%20el%20pack%20de%20banners%20de%20Casas%20Espania%20y%20c%C3%B3mo%20activarlo."
            target="_blank"
