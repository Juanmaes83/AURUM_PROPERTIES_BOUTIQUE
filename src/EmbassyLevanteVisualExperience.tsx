...
const benefits = [
  {
    ...
    body: 'Embassy Levante muestra al propietario cómo quedará su vivienda antes de firmar el mandato. No es una promesa, es una demostración.',
  },
  {
    icon: Smartphone,
  ...
  },
  {
    ...
    body: 'Se envía por WhatsApp, se incrusta en la web de Embassy Levante o se pone en campaña. Un activo, tres usos distintos.',
  },
  {
    icon: TrendingUp,
...
const useCases = [
  ...
  { label: 'Web de Embassy Levante', desc: 'Embed directo en la ficha de la propiedad o en la página de inicio para captar la atención del visitante.' },
...
export const EmbassyLevanteVisualExperience = () => {
  useSmoothScroll();

  return (
    <>
      <Helmet>
        <title>Experiencia Visual · Embassy Levante · Immersphere</title>
        <meta
          name="description"
          content="Experiencia visual interactiva personalizada para Embassy Levante. Muestra al propietario cómo quedará su vivienda antes de firmar."
        />
            ...
            >
              <div className="inline-flex items-center gap-3 border border-[#c4a96a]/30 bg-black/40 px-4 py-2 backdrop-blur-sm mb-8">
                <span className="text-[10px] tracking-[0.28em] uppercase text-[#c4a96a] font-mono">
                  EMBASSY LEVANTE · EXPERIENCIA VISUAL DE CAPTACIÓN
                </span>
              </div>
              ...
              <p className="mt-8 max-w-xl text-lg md:text-xl text-[#b0a390] leading-relaxed">
                ...
                Embassy Levante antes de hablar con la competencia. Torrevieja y la Costa Blanca, con la calidad
          ...
          <div className="max-w-7xl mx-auto grid gap-12 lg:grid-cols-[1fr_1.1fr] items-center">
            ...
            >
              <span className="text-[10px] tracking-[0.32em] text-[#c4a96a] font-mono">
                PIEZA PERSONALIZADA · EMBASSY LEVANTE
              </span>
              ...
              <p className="mt-6 text-base md:text-lg text-[#cfcfcf] leading-relaxed">
                La experiencia convierte una propiedad de Embassy Levante en un activo visual dinámico: imagen con
          ...
          <div className="max-w-6xl mx-auto grid gap-10 lg:grid-cols-2 items-start">
            <div>
              ...
              <p className="mt-6 text-[#8a8078] leading-relaxed">
                La misma experiencia visual puede activarse en todos los canales que Embassy Levante usa hoy para
        ...
        <section className="relative py-28 md:py-36 px-6 md:px-12 overflow-hidden bg-gradient-to-br from-[#0B0B0C] via-[#1A140A] to-[#0F0F10]">
          ...
          >
            ...
            <p className="mt-6 text-[#8a8078] leading-relaxed max-w-xl mx-auto">
              La propuesta más directa es empezar con una propiedad concreta de Embassy Levante, crear la
            ...
            <p className="mt-8 text-xs text-[#555]">
              Propuesta conceptual. Revisión y validación final por Embassy Levante.
            </p>
          </motion.div>
        </section>
      </main>
