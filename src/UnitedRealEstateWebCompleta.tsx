...
export function UnitedRealEstateWebCompleta() {
  ...
  return (
    <main data-client-slug="united-real-estate" style={{ background: "#0a0a0a", color: "#fff", fontFamily: "Arial,sans-serif" }}>
      ...
      <section style={{ padding: "80px 24px", background: "#111" }}>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", borderRadius: 8, overflow: "hidden" }}>
          <iframe src="https://rubik-sota-director-de-orquesta.vercel.app/gesture-lab/united-real-estate-v1" style={{ width: "100%", height: 600, border: "none" }} title="Visual Experience United Real Estate" />
        </div>
      </section>
