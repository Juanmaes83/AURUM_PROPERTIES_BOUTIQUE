...
const fourHooks = [
  {
    ...
    href: '/visual-experience/casas-espania',
    tag: 'Ver pieza',
  },
  {
    num: '02',
  ...
  },
  {
    ...
    href: '/casas-espania-web-completa',
    tag: 'Ver web',
  },
  {
    num: '04',
    ...
    href: '/banners/casas-espania',
    tag: 'Ver banners',
  },
];

const valueProps = [
  { label: 'Argumento visual para propietarios', body: 'Casas Espania puede mostrar al propietario exactamente cómo se presentará su vivienda antes de firmar el mandato. Menos tiempo de convicción, más cierres.' },
  { label: 'Captación diferenciada', body: 'La presentación visual eleva la percepción de la agencia y diferencia a Casas Espania de la competencia local en Torrevieja.' },
...
export const CasasEspaniaLanding = () => {
  useSmoothScroll();

  return (
    <>
      <Helmet>
        <title>Casas Espania · Propuesta Visual · Immersphere</title>
        <meta
          name="description"
          content="Propuesta visual personalizada para Casas Espania: experiencia interactiva, landing comercial, web completa y banners para Torrevieja y la Costa Blanca."
        />
      ...
      <main className="bg-[#0B0B0C] text-[#F7F7F7]">
        ...
        <VisualExperienceBannerSection
          ...
          horizontalUrl="/banners/casas-espania/horizontal"
          verticalUrl="/banners/casas-espania/vertical"
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-[#555] leading-relaxed max-w-2xl mb-12">
                Cada pieza tiene un objetivo comercial propio. Juntas forman un sistema visual que Casas Espania
