...
const formats = [
  {
    ...
    href: '/banners/embassy-levante/vertical',
    previewRatio: '9/16',
    previewMaxH: 420,
  },
  {
    ...
    href: '/banners/embassy-levante/horizontal',
    previewRatio: '16/9',
    previewMaxH: 220,
  },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Tu propiedad en Torrevieja con Embassy Levante.
        </p>
        <p
      ...
      <div className="absolute bottom-0 left-0 right-0 px-4 py-3 bg-gradient-to-t from-black/80 to-transparent">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-[10px] text-[#f5f0e8] font-semibold">+34 691 502 743</p>
          </div>
...
export const EmbassyLevanteBannerPack = () => {
  return (
    <>
      <Helmet>
        <title>Pack de Banners · Embassy Levante · Immersphere</title>
      ...
      <div className="min-h-screen bg-[#0B0B0C] text-[#F7F7F7] font-[Inter,sans-serif]">
        ...
        <div className="border-b border-[#c4a96a]/15 px-6 py-4 flex items-center justify-between">
          <div>
            <span className="font-serif text-[#c4a96a] text-lg">Embassy Levante</span>
        ...
        <section className="px-6 md:px-12 py-16 max-w-5xl mx-auto">
          ...
          >
            <p className="text-[10px] font-mono text-[#c4a96a] tracking-[0.28em] uppercase mb-4">
              EMBASSY LEVANTE · CREATIVIDADES VISUALES
            </p>
            ...
            <p className="text-[#8a8078] leading-relaxed max-w-xl">
              Formatos vertical 9:16 y horizontal 16:9 con claim, identidad Embassy Levante y CTA de contacto
        ...
        <section className="bg-[#0e0c0a] px-6 md:px-12 py-16 text-center">
          ...
          <p className="text-[#8a8078] max-w-md mx-auto mb-10 text-sm leading-relaxed">
            Una vez validados por Embassy Levante, estos banners se adaptan a propiedades reales y se
            entregan listos para activar en captación de propietarios y campaña digital.
          </p>
          <a
            href="https://wa.me/34691502743?text=Hola%2C%20quiero%20ver%20el%20pack%20de%20banners%20de%20Embassy%20Levante%20y%20c%C3%B3mo%20activarlo."
            target="_blank"
