...
import { MapPin, Phone, Mail, Clock, Check, ChevronRight, Home, Building2, Users, Star } from 'lucide-react';
...
const LANDING_URL = '/sandhouse-inmobiliaria';

const zones = [
  {
    name: 'Torrevieja',
    desc: 'Ciudad costera con uno de los mercados inmobiliarios más activos de la Costa Blanca. Vivienda vacacional y residencial para compradores nacionales e internacionales.',
    tag: 'Mercado principal',
  },
  {
    name: 'Costa Blanca',
    desc: 'Más de 200 km de costa en la provincia de Alicante con alta demanda de segunda residencia. Clima mediterráneo, infraestructura y conexión internacional.',
    tag: 'Zona de influencia',
  },
  {
    name: 'Costa Levantina',
    desc: 'Desde Murcia hasta Valencia, un territorio con creciente interés de compradores europeos y españoles en busca de primera y segunda residencia.',
    tag: 'Expansión',
  },
];
...
const services = [
  {
    ...
    desc: 'Asesoramiento integral en la compra y venta de viviendas en Torrevieja y la Costa Levantina. Conocimiento local, gestión completa.',
  },
  {
    icon: Building2,
    title: 'Vivienda vacacional',
    desc: 'Propiedades para primera o segunda residencia orientadas al comprador que busca calidad de vida en la costa. Selección, visita y negociación acompañadas.',
  },
  {
    icon: Users,
    title: 'Asesoramiento personalizado',
    desc: 'Cada comprador tiene una situación distinta. Sandhouse escucha, filtra y acompaña desde el primer contacto hasta la firma.',
  },
  {
    icon: Star,
    title: 'Gestión de la operación',
    desc: 'Más allá de la propiedad: Sandhouse coordina los pasos legales, notariales y administrativos para que la operación sea clara y sin fricción.',
  },
];

const propertyCards = [
  { tipo: 'Apartamento', zona: 'Torrevieja Centro', m2: '85 m²', dorms: '2 hab.', accent: 'Vista al lago salado', badge: 'Destacado' },
  { tipo: 'Villa', zona: 'Los Altos · Torrevieja', m2: '220 m²', dorms: '4 hab.', accent: 'Piscina privada', badge: 'Exclusivo' },
  { tipo: 'Piso', zona: 'Playa del Cura', m2: '65 m²', dorms: '2 hab.', accent: 'Primera línea de playa', badge: 'Oportunidad' },
];

const method = [
  { step: '01', title: 'Escucha', body: 'Entendemos qué busca el comprador: zona, presupuesto, uso de la propiedad, urgencia. No empezamos a mostrar hasta entender.' },
  { step: '02', title: 'Selección', body: 'Filtramos la cartera disponible y presentamos solo lo que encaja. Menos visitas, más calidad en cada una.' },
  { step: '03', title: 'Visita', body: 'Acompañamos cada visita. Explicamos, contextualizamos y respondemos. El comprador sale con claridad, no con dudas.' },
  { step: '04', title: 'Negociación', body: 'Con conocimiento real del mercado en Torrevieja, negociamos con criterio para ambas partes. Transparencia total.' },
  { step: '05', title: 'Acompañamiento', body: 'Hasta la firma y después. Sandhouse no desaparece cuando se cierra la operación.' },
];
...
export const SandhouseWebCompleta = () => {
  useSmoothScroll();
  ...
  return (
    <>
      <Helmet>
        <title>Sandhouse Inmobiliaria · Web Completa · Immersphere Pro</title>
        <meta
          name="description"
          content="Propuesta web completa para Sandhouse Inmobiliaria: presentación de agencia, zonas, servicios, propiedades y contacto directo en Torrevieja y la Costa Levantina."
        />
      ...
      <main className="bg-[#0B0B0C] text-[#F7F7F7] pt-[89px]">
        ...
        <section id="inicio" className="relative min-h-screen overflow-hidden flex items-center">
          ...
          <div className="relative z-10 max-w-7xl mx-auto w-full px-6 md:px-12 py-24">
            ...
            >
              <div className="inline-flex items-center gap-3 border border-[#c4a96a]/35 bg-black/40 px-4 py-2 backdrop-blur-sm">
                <span className="text-[10px] tracking-[0.28em] uppercase text-[#c4a96a] font-mono">
                  SANDHOUSE INMOBILIARIA · TORREVIEJA · COSTA LEVANTINA
                </span>
              </div>
            </motion.div>
            ...
            >
              Tu próxima vivienda en Torrevieja empieza con una experiencia más clara, visual y cercana.
            </h1>
            ...
            >
              Sandhouse Inmobiliaria acompaña a compradores y propietarios en Torrevieja, la Costa Blanca y la
              Costa Levantina. Experiencia local, servicio personalizado, resultados concretos.
            </motion.p>
            ...
            <div className="max-w-6xl mx-auto grid gap-10 lg:grid-cols-[1fr_1.2fr] items-center">
              <div>
                ...
                <p className="mt-6 text-[#555] leading-relaxed">
                  Desde C/ Lanzarote 21 bajo en Torrevieja, Sandhouse Inmobiliaria trabaja para que cada
                  comprador encuentre exactamente lo que busca: la propiedad adecuada, en el momento correcto,
                  con el acompañamiento que merece una decisión de esta envergadura.
                </p>
                <a
              ...
              <div className="grid gap-4">
                {[
                  ...
                  { label: 'Teléfono principal', value: cfg.client.phone },
                  { label: 'Email', value: cfg.client.email },
                  { label: 'Horario', value: cfg.client.hours },
                ].map((item) => (
          ...
          <SectionReveal>
            <div className="max-w-6xl mx-auto">
              ...
              <h2 className="font-serif text-4xl md:text-5xl leading-tight mt-4 mb-14 max-w-2xl">
                Torrevieja y la Costa Levantina.
              </h2>
        ...
        <section id="servicios" className="bg-[#0e0c0a] py-24 md:py-32 px-6 md:px-12">
          <SectionReveal>
            <div className="max-w-6xl mx-auto">
              ...
              <h2 className="font-serif text-4xl md:text-5xl leading-tight mt-4 mb-14 max-w-2xl">
                Todo lo que necesitas para comprar o vender en la Costa Blanca.
              </h2>
          ...
          <SectionReveal>
            <div className="max-w-6xl mx-auto">
              ...
              <p className="text-[#8a8078] mb-14 max-w-xl">
                Estas tarjetas son placeholders editoriales de la propuesta. Las propiedades reales de Sandhouse
                se integran con los activos validados por el equipo.
              </p>
              <div className="grid gap-6 md:grid-cols-3">
                {propertyCards.map((p) => (
                  <div key={p.tipo + p.zona} className="border border-white/8 overflow-hidden group">
                    <div
                      className="h-52 bg-gradient-to-br from-[#1a1510] via-[#231c12] to-[#0d0b09] flex items-end p-5 relative"
                    >
        ...
        <section id="metodo" className="bg-[#0e0c0a] py-24 md:py-32 px-6 md:px-12">
          <SectionReveal>
            <div className="max-w-6xl mx-auto">
              ...
              <h2 className="font-serif text-4xl md:text-5xl leading-tight mt-4 mb-14 max-w-2xl">
                Del primer contacto a las llaves: cinco pasos claros.
              </h2>
        ...
        <section id="experiencia-visual" className="py-24 md:py-32 px-6 md:px-12">
          <SectionReveal>
            <div className="max-w-6xl mx-auto grid gap-12 lg:grid-cols-2 items-center">
              <div>
                <span className="text-[10px] tracking-[0.32em] text-[#c4a96a] font-mono">
                  POR QUÉ MEJORAR LA EXPERIENCIA VISUAL
                </span>
                <h2 className="font-serif text-4xl md:text-5xl leading-tight mt-4 mb-6">
                  En Torrevieja, quien impacta primero, capta primero.
                </h2>
                <p className="text-[#8a8078] leading-relaxed mb-6">
                  El mercado inmobiliario en Torrevieja es activo y competitivo. El comprador compara varias
                  agencias antes de decidir a cuál llama. Una presentación visual más cuidada decide cuál
                  recuerda.
                </p>
          ...
          <SectionReveal>
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-[#8a8078] max-w-xl mx-auto mb-12 leading-relaxed">
                El equipo de Sandhouse Inmobiliaria está en C/ Lanzarote 21 bajo, Torrevieja. Por teléfono,
                WhatsApp o email, el tiempo de respuesta es el que merece una decisión importante.
              </p>
              ...
              <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-4 text-sm text-[#b0a390] max-w-3xl mx-auto">
                ...
                <div className="flex flex-col items-center gap-2 text-center">
                  ...
                  <div>
                    <div>{cfg.client.phone}</div>
                    <div>{cfg.client.phone2}</div>
                    <div>{cfg.client.phone3}</div>
                  </div>
                </div>
                <div className="flex flex-col items-center gap-2 text-center">
                ...
                <div className="flex flex-col items-center gap-2 text-center">
                  <Clock size={16} className="text-[#c4a96a]" />
                  <span>{cfg.client.hours}</span>
                </div>
              </div>
            </div>
          </SectionReveal>
        ...
        <footer className="py-6 px-6 border-t border-white/5">
          <p className="text-center text-[0.6rem] text-[#3a3530] tracking-[0.08em] font-mono">
            Propuesta conceptual · Immersphere Pro · Revision y validacion por Sandhouse Inmobiliaria antes de publicar
          </p>
        </footer>
      </main>
    </>
