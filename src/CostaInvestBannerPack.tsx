...
const banners = [
  {
    ...
    href: `${AURUM}/banners/costa-invest/vertical`,
    localHref: '/banners/costa-invest/vertical',
  },
  {
    id: 'horizontal',
    label: 'Banner Horizontal',
    spec: '1920 × 1080 · Display · YouTube',
    href: `${AURUM}/banners/costa-invest/horizontal`,
    localHref: '/banners/costa-invest/horizontal',
  },
];

export function CostaInvestBannerPack() {
  return (
    <div
      style={{
        minHeight: '100vh',
    ...
    >
      <div style={{ textAlign: 'center', maxWidth: 480 }}>
        ...
        <p style={{ fontSize: '0.875rem', color: '#b0a390', lineHeight: 1.6 }}>
          Banners animados con imagen de propiedad, QR y CTA para compradores internacionales.
        </p>
      </div>
      ...
      <p style={{ fontSize: '0.7rem', color: '#635a50', textAlign: 'center' }}>
        Preview conceptual · Activos pendientes de validación por Costa Invest
      </p>
    </div>
  );
}
